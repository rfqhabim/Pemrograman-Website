...
$query = "SELECT * FROM product WHERE kategori_product = 'baterai' or 'Baterai'";
...
<body>
    ...
    <div class="bars">
        <div class="button-choice">
            ...
            <a class="nav-link active" href="baterai.php">Baterai</a>
        </div>
    </div>

    <div class="container-main">
        <?php foreach ($result as $data) : ?>
            <?php if ($data['KATEGORI_PRODUCT'] == 'Baterai') : ?>
                <div class="box">
